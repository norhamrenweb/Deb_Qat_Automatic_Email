                    ...
                    <legend>Parents notification</legend>
                        ...
                        <div class="col-xs-12 center-block">
                            ...
                            <div class="col-xs-10 form-group">
                                <input type="text" class="form-control" name="destino[]" id="destino"  placeholder="Name" required>
                            </div>
                            <div class="col-xs-1">
...
<!--                    SELECCIONA DESTINATARIOS MAIL-->
                        <div class="col-xs-12 center-block hidden" id="divRecipients" style="margin-bottom: 20px;">
                            <div class="col-xs-6">
                                <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-8">
                                        <select class="form-control" size="20" multiple name="origen[]" id="origen" style="width: 100% !important;" ondblclick="addMail()">
